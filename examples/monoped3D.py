"""
    ...
    >>> robot, add_pyomo_constraints = pe.models.monoped3D()
    ...
    >>> pe.utils.default_solver(max_mins=10, solver='ma86', OF_hessian_approximation='limited-memory').solve(robot.m, tee=True)
